...
const createInputWrapper = ({ classNameDiv , classNameLabel , valueLabel , typeInput =null , classNameInput , idInput =null , nameAtr =null  })=>{
...
const showMessage = (message)=>{
    const wrapperTest = (0, _redom.el)("div", {
        className: "unit"
    });
    const unitText = (0, _redom.el)("h2");
    unitText.textContent = message;
    (0, _redom.setChildren)(wrapperTest, [
        unitText
    ]);
...
const formShow = (name, number, date, cvv, form)=>{
    ...
    form.addEventListener("submit", (e)=>{
        ...
        e.preventDefault();
        form.reset();
        if ((0, _validation.validCardHolder)(creditCardValue.holder) && (0, _validation.validCardNumber)(creditCardValue.number) && (0, _validation.validCardCVC)(creditCardValue.cvv)) showMessage("Данные валидны");
        else showMessage("Данные не валидны!!!");
    });
};
const createForm = ()=>{
...
},{"redom":"iahd6","cleave.js":"dYrzx","@parcel/transformer-js/src/esmodule-helpers.js":"8jubI","./validation":"aJfE8"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"8jubI"}],"aJfE8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "validCardHolder", ()=>validCardHolder);
parcelHelpers.export(exports, "validCardNumber", ()=>validCardNumber);
parcelHelpers.export(exports, "validCardCVC", ()=>validCardCVC);
const validCardHolder = (cardHolder)=>{
    if (cardHolder.trim().split(" ").length === 1) return false;
    if (/[а-яА-Я]/.test(cardHolder)) return false;
    if (/\d/.test(cardHolder)) return false;
    return true;
};
const validCardNumber = (cardNumber)=>{
    if (/[а-яА-Я]/.test(cardNumber)) return false;
    if (/[a-zA-Z]/.test(cardNumber)) return false;
    if (/[^\w\s]/.test(cardNumber)) return false;
    if (String(cardNumber).length < 15 || String(cardNumber).length > 17) return false;
    return true;
};
const validCardCVC = (cardCVC)=>{
    if (cardCVC.length < 3 && cardCVC.length >= 4) return false;
    if (/[а-яА-Я]/.test(cardCVC)) return false;
    if (/[a-zA-Z]/.test(cardCVC)) return false;
    if (/[^\w\s]/.test(cardCVC)) return false;
    return true;
